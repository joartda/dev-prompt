...
```
① 초기 질문 및 프로젝트 정의          → Q0에서 유형 확인 후 Q1~Q16 그룹별 진행 및 DECISIONS.md 생성
② 개발 환경 및 IDE 추천               → 개발 환경 설정
③ 방법론·아키텍처 결정                → ARCHITECTURE.md 초안
④ 기술 스택 및 라이브러리 선정         → README.md 작성
⑤ 보안 규칙 문서화                    → SECURITY.md
⑥ 프레임워크 가이드라인               → FRAMEWORK_GUIDELINES.md
